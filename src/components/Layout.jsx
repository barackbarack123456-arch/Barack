        ...
        <header className="flex justify-between items-center h-16 bg-white border-b-2">
          ...
          <div className="flex items-center pr-4 relative">
            ...
            <Transition
              show={dropdownOpen}
            >
              <div className="absolute right-0 mt-2 w-56 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none top-full transition data-enter:ease-out data-enter:duration-100 data-leave:ease-in data-leave:duration-75 data-closed:transform data-closed:opacity-0 data-closed:scale-95">
                <div className="py-1">
